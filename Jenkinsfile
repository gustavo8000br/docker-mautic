pipeline {
  ...
  stages {
    ...
    // If this is a fpm build use live docker endpoints
    ...
    stage('Github-Tag-Push-Release') {
      ...
      steps {
        ...
        -d '{"tag":"'${EXT_RELEASE_CLEAN}'-'${EXT_VERSION_TYPE}'-build-'${MY_TAG_NUMBER}'",\
             "object": "'${COMMIT_SHA}'",\
             "message": "Tagging Release '${EXT_RELEASE_CLEAN}'-'${EXT_VERSION_TYPE}'-build-'${MY_TAG_NUMBER}' to fpm",\
             "type": "commit",\
